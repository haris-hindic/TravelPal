    ...
    public class TestDataController : ControllerBase
    {
        ...
        public IActionResult GenerateAccommodations()
        {
            ...
            accommodations.Add(new Accommodation
            {
                ...
                Rooms = 2,
                Capacity = 4,
                Location = new Location() { CityId = cities[1].Id, Address = "Second street", 
            ...
            accommodations.Add(new Accommodation
            {
                ...
                Rooms = 3,
                Capacity = 5,
                Location = new Location() { CityId = cities[2].Id, Address = "Third street", 
                    Latitude = 43.06532474316451, Longitude = 19.75112099200611
                },
                AccommodationDetails = new AccommodationDetails()
                {
                    AirConditioning = true,
            ...
            accommodations.Add(new Accommodation
            {
                ...
                Rooms = 2,
                Capacity = 3,
                Location = new Location() { CityId = cities[3].Id, Address = "Fourth street", 
                    Latitude = 42.305360027513515, Longitude = 18.838157141582418
                },
                AccommodationDetails = new AccommodationDetails()
                {
                    AirConditioning = true,
            ...
            accommodations.Add(new Accommodation
            {
                ...
                Rooms = 2,
                Capacity = 5,
                Location = new Location() { CityId = cities[4].Id, Address = "Fifth street", 
                    Latitude = 42.643266197038294, Longitude = 18.117454033346224
                },
                AccommodationDetails = new AccommodationDetails()
                {
                    AirConditioning = true,
            ...
            accommodations.Add(new Accommodation
            {
                ...
                Rooms = 3,
                Capacity = 4,
                Location = new Location() { CityId = cities[5].Id, Address = "Main road", 
                    Latitude = 42.48304898522179, Longitude = 18.47341108136003
                },
                AccommodationDetails = new AccommodationDetails()
                {
                    MosquitoNet = true,
            ...
            accommodations.Add(new Accommodation
            {
                ...
                Rooms = 1,
                Capacity = 2,
                Location = new Location() { CityId = cities[6].Id, Address = "8 mile", 
                    Latitude = 43.1655363173692, Longitude = 16.467307582498837
                },
                AccommodationDetails = new AccommodationDetails()
                {
                    AirConditioning = true,
            ...
            accommodations.Add(new Accommodation
            {
                ...
                Rooms = 2,
                Capacity = 4,
                Location = new Location() { CityId = cities[7].Id, Address = "Road 66", 
                    Latitude = 43.67670049339411, Longitude = 17.77698553692002
                },
                AccommodationDetails = new AccommodationDetails()
                {
                    AirConditioning = true,
            ...
            accommodations.Add(new Accommodation
            {
                ...
                Rooms = 3,
                Capacity = 6,
                Location = new Location() { CityId = cities[8].Id, Address = "Victory street", 
                    Latitude = 43.65975275793134, Longitude = 17.96673298298538
                },
                AccommodationDetails = new AccommodationDetails()
                {
                    AirConditioning = true,
            ...
            accommodations.Add(new Accommodation
            {
                ...
                Rooms = 2,
                Capacity = 3,
                Location = new Location() { CityId = cities[9].Id, Address = "Second boulevar", 
                    Latitude = 42.41576478158465, Longitude = 18.781107522420424
                },
                AccommodationDetails = new AccommodationDetails()
                {
                    AirConditioning = true,
